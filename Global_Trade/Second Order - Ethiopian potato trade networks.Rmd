---
title: "Ethiopian trade network extended"
author: "Aaron Plex"
date: "10/23/2021"
...
## Network of trade to and from Ethiopia
...
## Node out strength: Potato trade risk including immediate and second order trade of countries with Ethiopia
...
1) Pathogen invasion potential - This factor considers the level of potato harvested area and pest status for brown rot of potato (Ralstonia solanacearum race 3 biovar 2) in each country.  

2) Pathogen trade movement potential - This factor considers the level of potato trade between countries and the level of pest status for brown rot of potato.

3) We combined these two factors in a trade connectivity risk index (TCRI) which for this analysis is included in the country strength of each country. Closeness to the network center is proportional to higher TCRI.
